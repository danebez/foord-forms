...
import bean.TopupFormBean;

public class TopupForm extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		TopupFormBean formBean = (TopupFormBean) request.getSession()
				.getAttribute("topupFormBean");
		...
		request.getSession().removeAttribute("topupFormBean");
		...
		String fileName = "Foord Investor Top-up Form "
		...
		try {
			Email.sendEmail(filePath, "Foord Investor Top-up Form", toAddress,
					fileName);
			Email.sendEmail(filePath, "Online Top-up Form - " + name,
