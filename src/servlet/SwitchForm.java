...
import bean.SwitchFormBean;

public class SwitchForm extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		SwitchFormBean formBean = (SwitchFormBean) request.getSession()
				.getAttribute("switchFormBean");
		...
		request.getSession().removeAttribute("switchFormBean");
		...
		String fileName = "Foord Investor Switch Form "
		...
		try {
			Email.sendEmail(filePath, "Foord Investor Switch Form",
					toAddress, fileName);
			Email.sendEmail(filePath, "Online Switch Form - " + name,
