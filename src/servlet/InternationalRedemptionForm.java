...
import bean.InternationalRedemptionFormBean;

public class InternationalRedemptionForm extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		InternationalRedemptionFormBean formBean = (InternationalRedemptionFormBean) request
				.getSession().getAttribute("internationalRedemptionFormBean");

		String toAddress = formBean.getInvestorEmailAddress();

		String name = formBean.getInvestorName();
		
		request.getSession().removeAttribute("internationalRedemptionFormBean");
